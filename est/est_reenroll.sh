...
curl --cert ./oldkey/certs.pem --key ./oldkey/testEST.key --data @./newkey/testEST.csr  -o certs-p7.b64 -H "Content-Type: application/pkcs10" -H "Content-Transfer-Encoding: base64" https://ca.erik.local/.well-known/est/estra/simplereenroll
